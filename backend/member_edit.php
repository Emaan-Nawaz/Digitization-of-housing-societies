...
$updateuser = "SELECT * FROM users WHERE id = '{$edit_id}'";
...
$updateUser = "UPDATE users SET name = \"$username\", email = \"$email\", password = \"$password\", contact = \"$phone\", cnic = \"$cnic\" WHERE id = \"$edit_id\"  ";
